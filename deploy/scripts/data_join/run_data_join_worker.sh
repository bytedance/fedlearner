...
negative_sampling_frequency=$(normalize_env_to_args '--negative_sampling_frequency' $NEGATIVE_SAMPLING_FREQUENCY)
...
python -m fedlearner.data_join.cmd.data_join_worker_service \
    ...
    $enable_negative_example_generator $negative_sampling_frequency
