...
psi_signer_cmd=/app/deploy/scripts/sgx/run_rsa_psi_signer.sh
psi_preprocessor_cmd=/app/deploy/scripts/sgx/run_psi_preprocessor.sh
data_join_worker_cmd=/app/deploy/scripts/sgx/run_data_join_worker.sh
