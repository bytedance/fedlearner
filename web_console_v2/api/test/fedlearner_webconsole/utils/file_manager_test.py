...
from fedlearner_webconsole.utils.file_manager import (
    DefaultFileManager, HdfsFileManager, FileManager, File)
...
class HdfsFileManagerTest(unittest.TestCase):
    def setUp(self):
        ...
        self._client_patcher = patch(
            'fedlearner_webconsole.utils.file_manager._hdfs_client',
            self._mock_client)
    ...
    def test_ls(self):
        ...
        self.assertEqual(
            ...
            [File(path='hdfs:///data/abc', size=1024)]
        )
