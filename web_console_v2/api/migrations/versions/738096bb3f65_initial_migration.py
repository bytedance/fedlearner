...
Revision ID: 738096bb3f65
Revises: 
Create Date: 2021-03-04 18:29:59.231913
...
def upgrade():
    ...
    op.create_index(op.f('ix_workflow_v2_uuid'), 'workflow_v2', ['uuid'], unique=True)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_workflow_v2_uuid'), table_name='workflow_v2')
