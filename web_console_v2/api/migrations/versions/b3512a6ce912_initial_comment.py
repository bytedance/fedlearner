...
def upgrade():
    ...
    sa.Column('config', sa.LargeBinary(16777216), nullable=False, comment='config'),
    ...
    sa.Column('config', sa.LargeBinary(16777216), nullable=True, comment='config'),
    sa.Column('cmt', sa.String(length=255), nullable=True, comment='comment'),
    ...
    sa.Column('fork_proposal_config', sa.LargeBinary(16777216), nullable=True, comment='fork_proposal_config'),
