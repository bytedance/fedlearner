...
export const normalAlgorithmProject: AlgorithmProject = {
  id: 3,
  name: 'e2e test',
  project_id: 1,
  latest_version: 0,
  type: 'NN_VERTICAL' as EnumAlgorithmProjectType,
  source: 'USER',
  ...
  username: 'abcabc',
  participant_id: null,
  path: '/data/algorithm_projects/e2e-test-20211206_115929-57da1',
  parameter: {
    variables: [
      {
        name: 'aaa',
  ...
  created_at: 1638791969,
  updated_at: 1638864824,
  deleted_at: null,
  algorithms: [
    {
      id: 3,
      ...
      username: 'abcabc',
      participant_id: null,
      path: '/data/algorithms/e2e-test-v1-20211206_115929-2db0f',
