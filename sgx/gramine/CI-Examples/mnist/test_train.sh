...
taskset -c 0-3 gramine-sgx python -u train.py --task_index=0 --job_name=ps --loglevel=debug 2>&1 | logfilter | tee -a ps0-gramine-python.log & 
taskset -c 4-7 gramine-sgx python -u train.py --task_index=0 --job_name=worker --loglevel=debug 2>&1 | logfilter | tee -a worker0-gramine-python.log &
