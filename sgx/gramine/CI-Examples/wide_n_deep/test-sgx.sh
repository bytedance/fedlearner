...
if [ "$ROLE" == "data" ]; then
    ...
    make_custom_env
    rm -rf model/leader
    taskset -c 0-3 stdbuf -o0 gramine-sgx python -m fedlearner.trainer.parameter_server localhost:40051 2>&1 | runtime_logfilter | tee -a leader-gramine-ps.log & 
    ...
    taskset -c 8-11 stdbuf -o0 gramine-sgx python -m fedlearner.trainer.parameter_server localhost:40061 2>&1 | runtime_logfilter | tee -a follower-gramine-ps.log & 
